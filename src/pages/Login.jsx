...
function Login() {
    ...
    let url = `${AUTH_ENDPOINT}?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URL}&response_type=${RESPONSE_TYPE}&scope=user-read-recently-played,user-top-read,playlist-modify-public`
    return ( 
